...
public class TechnologyController {
    ...
    public String updateTechnology(
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Technology updated successfully!");
        return "redirect:/admin/technology?page=0&size=10";
    }
    ...
    public String deleteTechnology(
        ...
        Technology technology = technologyService.findTechnologyById(id);
        if (technology == null) {
            redirectAttributes.addFlashAttribute("errorMessage", "Technology not found!");
            return "redirect:/admin/technology?page=0&size=10";
        }

        int result = technologyService.deleteTechnology(id);
        if (result > 0) {
            if (technology.getName().endsWith("_deleted")) {
                redirectAttributes.addFlashAttribute("successMessage", "Technology marked as deleted!");
            } else {
                redirectAttributes.addFlashAttribute("successMessage", "Technology deleted successfully!");
            }
        } else {
            redirectAttributes.addFlashAttribute("errorMessage", "Failed to delete technology due to existing references!");
        }
        return "redirect:/admin/technology?page=0&size=10";
    }
}
